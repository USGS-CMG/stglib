...
parser = argparse.ArgumentParser(description='Convert EXO .xlsx file to raw .cdf format. Run this script from the directory containing EXO file')
...
RAW = stglib.exo.xls_to_cdf(metadata)
