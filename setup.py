...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "runsgwvswb2cdf.py=stglib.core.runcmd:runsgwvswb2cdf",
            "runsgwvscdf2nc.py=stglib.core.runcmd:runsgwvscdf2nc",
            "runsgwvsnc2waves.py=stglib.core.runcmd:runsgwvsnc2waves",
