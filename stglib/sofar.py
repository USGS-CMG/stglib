...
data_files = ['Szz.csv', 'Sxx.csv', 'Sxy.csv', 'Syy.csv', 'bulkparameters.csv','a1.csv','b1.csv','a2.csv','b2.csv']

df = pd.read_csv(data_fol + '/' + data_files[0])

def read_spotter(filnam, skiprows=25, encoding="utf-8"):
